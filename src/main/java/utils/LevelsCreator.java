...
import entities.Monster; // Assure-toi que ce soit bien importé
    ...
    public static Level generateRandomLevel(int levelNumber) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            for (int i = 0; i < 4 * levelNumber; i++) {
                double posX = Constants.TILE_SIZE * (random.nextInt(maxTilesX) + 1.1);
                double posY = Constants.TILE_SIZE * (random.nextInt(maxTilesY) + 1.1);
